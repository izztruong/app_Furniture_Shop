...
import com.example.app_furniture_shop.databinding.FragmentSofaBinding;
...
public class SofaFragment extends Fragment implements OnclickItem {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding= FragmentSofaBinding.bind(view);
        setView();
        return view;
    }
    private void setView(){
        APIManagerService apiManagerService= RetrofitClient.getService();
        Call<ArrayList<Product>> call=apiManagerService.getProductfollowcategory("3");
    ...
    private void setAdapter(ArrayList<Product> list){
        ...
        binding.rcvSofa.setLayoutManager(layoutManager);
        binding.rcvSofa.setAdapter(adapter);
