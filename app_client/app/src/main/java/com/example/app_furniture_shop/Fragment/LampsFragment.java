...
import com.example.app_furniture_shop.databinding.FragmentTableBinding;
...
public class LampsFragment extends Fragment implements OnclickItem {
    private FragmentLampsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_lamps, container, false);
        binding= FragmentLampsBinding.bind(view);
        setView();
        return view;
    }
    private void setView(){
        APIManagerService apiManagerService= RetrofitClient.getService();
        Call<ArrayList<Product>> call=apiManagerService.getProductfollowcategory("4");
    ...
    private void setAdapter(ArrayList<Product> list){
        ...
        binding.rcvLamp.setLayoutManager(layoutManager);
        binding.rcvLamp.setAdapter(adapter);
