...
public class TableFragment extends Fragment implements OnclickItem {
    ...
    private void setView(){
        ...
        Call<ArrayList<Product>> call=apiManagerService.getProductfollowcategory("1");
    ...
    private void setAdapter(ArrayList<Product> list){
        ...
        binding.rcvTable.setAdapter(adapter);
