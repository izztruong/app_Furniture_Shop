...
import com.example.app_furniture_shop.databinding.FragmentChairBinding;
...
public class ChairFragment extends Fragment implements OnclickItem {
    ...
    private void setView(){
        ...
        Call<ArrayList<Product>> call=apiManagerService.getProductfollowcategory("2");
    ...
    private void setAdapter(ArrayList<Product> list){
        ...
        binding.rcvChair.setLayoutManager(layoutManager);
        binding.rcvChair.setAdapter(adapter);
